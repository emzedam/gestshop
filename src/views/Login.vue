    ...
    <section class="pb-0 pb-xl-5">
        <div class="container">
            <div class="row g-4 justify-content-between align-items-center">
                ...
                <!-- Right side START -->
                <div class="col-lg-12">
                    <h2 class="mb-3 mb-lg-5"> ورود به حساب کاربری</h2>
                    ...
                    <div class="col-12">
                        <form class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" v-model="loginData.mobile" placeholder="شماره موبایل را وارد کنید">
                            </div>
...
const doLogin = async () => {
    if(loginData.mobile != null && loginData.password != null){
        loading.value = true
        const sendDataForLogin = await store.dispatch("login_with_password" , loginData);
        if(sendDataForLogin.statusCode == 101 || sendDataForLogin.statusCode == 102 || sendDataForLogin.statusCode == 103 || sendDataForLogin.statusCode == 401){
            ...
            loading.value = false
            cookies.set("UToken" , sendDataForLogin.access_token , 60*60*24 , "/")
            $toast.success("به حساب کاربری خود در قسط شاپ خوش آمدید" , {
                position: "top-left"
            })
