<template>
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">آپلود فرم قرارداد</h6>
    </div>
    <div class="card-body mr-3">
      ...
      <div class="col-lg-12 pt-3 gap-6 d-flex">
        <button @click="upload_form_gharardad()" class="bg-success p-3 border-0 text-white ml-2" v-if="requestLoading == false" >ثبت</button>
        <button v-if="requestLoading == true" class="bg-success p-3 border-0 text-white ml-2" >در حال ارسال ...</button>
      </div>
    </div>
  </div>
</template>
