      ...
      <div class="container">
        ...
        <a class="navbar-brand" href="index.html">
          <!-- <img
            ...
            src="https://gestshop.ir/images/light.svg"
            alt="logo"
          /> -->
          <!-- <img
        ...
        <div class="navbar-collapse collapse" id="navbarCategoryCollapse">
          ...
          >
            <!-- Nav item Hotel -->
            <li class="nav-item">
              <a class="nav-link active" href="https://gestshop.ir/fa/"
                ><i class="fa-solid fa-shop me-2"></i>فروشگاه</a
              >
            </li>
            ...
            <li class="nav-item" v-if="authuser == null">
              <router-link class="nav-link" to="/login"
                ><i class="fa-solid fa-user me-2"></i>ورود یا ثبت نام</router-link
              >
            </li>
            <li class="nav-item" v-if="authuser != null">
              <a class="nav-link" href="javascript:void(0)" @click="logoutUser()"
                ><i class="fa-solid fa-user me-2"></i>خروج از حساب </a
              >
            </li>
          </ul>
        </div>
        ...
        <ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
          ...
          <li class="nav-item dropdown ms-0 ms-md-3 d-none">
            <!-- Notification button -->
            <a
                  ...
                  <ul class="list-group list-group-flush list-unstyled p-2">
                    ...
                    <li>
                      ...
                      >
                        ...
                        <p class="mb-0 small">
                          Find the flexible ticket on flights around the world.
          ...
          <li class="nav-item ms-3 dropdown d-none">
            <!-- Avatar -->
            <!-- <a
            ...
            >
              ...
              <li>
                <a class="dropdown-item" href="#"
                  ><i class="bi bi-bookmark-check fa-fw me-2"></i>My Bookings</a
                >
              </li>
              <li>
                <a class="dropdown-item" href="#"
                  ><i class="bi bi-heart fa-fw me-2"></i>My Wishlist</a
                >
              </li>
              <li>
                <a class="dropdown-item" href="#"
...
const authuser = computed(() => {
  return store.getters.get_authuser
})
...
const logoutUser = async ()=> {
  if(cookies.get("UToken") != null){
    if(confirm("آیا از خروج خود مطمعن هستید ؟")){
      const doLogout = await store.dispatch("do_user_logout", cookies.get("UToken"))
